...
L["SecondMountTooltipDescription"] = "Wenn du im Wasser bist, wird ein Nicht-Wasservogel-Reittier beschworen. Wenn du an Land bist und fliegen kannst, wird ein Boden-Reittier beschworen."
L["ZoneSettingsTooltip"] = "Merkmale der Zoneneinstellungen"
L["ZoneSettingsTooltipDescription"] = "Erstellen einer Liste von Mounts für die Zone. Konfigurieren der Zonenflags. Einrichten von Relationen zur Verwendung einer Liste von Mounts in verschiedenen Zonen."
L["ButtonsSelectedTooltipDescription"] = "Die Schaltflächen an der Seite wählt Reittiere nach Typ aus, um sie unter den entsprechenden Bedingungen zu beschwören. Favoriten haben keinen Einfluss auf die Beschwörung von Reittieren mit %s."
