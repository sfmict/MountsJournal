...
L["DEATHKNIGHT_USEPATHOFFROST"] = "召喚地面坐騎時使用％s"
L["DEATHKNIGHT_USEONLYINWATERWALKLOCATION"] = "僅在水上行走區使用"
L["SHAMAN_USEWATERWALKING"] = "召喚地面坐騎時使用％s"
L["SHAMAN_USEONLYINWATERWALKLOCATION"] = "僅在水上行走區使用"
