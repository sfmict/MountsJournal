...
L["Enable statistic collection"] = "Enable statistic collection"
L["STATISTIC_DESCRIPTION"] = "Collects time and distance of mounts (CPU load, only when character is mounted)"
