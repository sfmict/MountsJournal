...
L["Enable statistic collection"] = "Включить сбор статистики"
L["STATISTIC_DESCRIPTION"] = "Собирает время и расстояние поездок верхом (загружеает ЦП, только когда персонаж сидит верхом)"
