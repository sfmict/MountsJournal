...
L["ConfigPanelTitle %s."] = "Глобальные настройки"
...
L["DEATHKNIGHT_USEPATHOFFROST"] = "Использовать \"Path of Frost\" при вызове наземного средства передвижения"
L["SHAMAN_USEWATERWALKING"] = "Использовать \"Water Walking\" при вызове наземного средства передвижения"
