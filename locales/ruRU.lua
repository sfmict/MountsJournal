...
L["ThirdMountTooltipDescription"] = "Призывает обычных летающих маунтов."
...
L["Dragonriding First"] = "С полетами на драконах вначале"
...
L["Regular Flying Mounts Only"] = "Только обычные летающие средства передвижения"
...
L["DRACTHYR_USESOAR"] = "Использовать %s как маунт полетов на драконе"
L["WORGEN_USERUNNINGWILD"] = "Использовать %s как наземный маунт"
