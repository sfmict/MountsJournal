...
config:SetScript("OnShow", function(self)
	...
	-- MODIFIER COMBOBOX
	local modifierCombobox = LibStub("LibSFDropDown-1.1"):CreateButton(leftPanel)
	...
	self.repairMountsCombobox = LibStub("LibSFDropDown-1.1"):CreateButton(rightPanelScroll.child, 230)
