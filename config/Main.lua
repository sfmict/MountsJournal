...
config:SetScript("OnShow", function(self)
	...
	-- MODIFIER COMBOBOX
	local modifierCombobox = LibStub("LibSFDropDown-1.2"):CreateButton(leftPanel)
	...
	self.repairMountsCombobox = LibStub("LibSFDropDown-1.2"):CreateButton(rightPanelScroll.child, 230)
