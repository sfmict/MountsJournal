...
L["= (equal to)"] = "= (等于)"
L["sorting"] = "排序"
L["CTRL + drag to sort mounts"] = "Ctrl + 拖拽以排序坐骑"
L["Reset custom sorting"] = "重置自定义排序"
...
L["Expansion art"] = "资料片美术"
L["Show mount expansion art"] = "显示坐骑资料片美术"
L["MOUNT_EXPANSION_ART_DESCRIPTION"] = "在3D网格视图中，在坐骑后方显示资料片的美术图。"
...
L["Change random mount"] = "更换随机坐骑"
L["On each summon"] = "每次召唤时"
L["Every %s sec"] = "每 %s 秒"
L["Every %s min"] = "每 %s 分钟"
...
L["Add information to item tooltip"] = "向物品提示添加信息"
L["Rule Set"] = "规则集"
L["Rule Sets"] = "规则集"
...
L["CONDITION_DATA_SECRET_INFO"] = "当数据为秘密时始终为假。\n游戏在某些情况下不允许您检查条件。"
L["NOT_CONDITION"] = "非"
L["Conditions"] = "条件"
L["Action"] = "动作"
L["Edit Rule"] = "编辑规则"
...
L["Quest completed on account"] = "账号已完成任务"
L["Sex"] = "性别"
...
L["Random Mount of Selected Type by Rarity"] = "按稀有度随机选定类型坐骑"
...
L["Pet binding from profile"] = "配置文件中的宠物绑定"
L["Zone settings from profile"] = "配置文件中的区域设置"
...
L["Other profiles that link to \"%s\" will also be updated to \"%s\". Proceed?"] = "链接到\"%s\"的其他配置文件也将更新为\"%s\"。是否继续？"
-- TAGS
L["tags"] = "标签"
L["No tag"] = "无标签"
