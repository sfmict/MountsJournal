...
L["= (equal to)"] = "= (equal to)"
L["sorting"] = "Sorting"
L["CTRL + drag to sort mounts"] = "CTRL + drag to sort mounts"
L["Reset custom sorting"] = "Reset custom sorting"
...
L["Expansion art"] = "Expansion Art"
L["Show mount expansion art"] = "Show mount expansion art"
L["MOUNT_EXPANSION_ART_DESCRIPTION"] = "Displays expansion art behind mounts in 3D grid view."
...
L["Change random mount"] = "Change random mount"
L["On each summon"] = "On each summon"
L["Every %s sec"] = "Every %s sec"
L["Every %s min"] = "Every %s min"
...
L["Pet binding from profile"] = "Pet binding from profile"
L["Zone settings from profile"] = "Zone settings from profile"
...
L["Other profiles that link to \"%s\" will also be updated to \"%s\". Proceed?"] = "Other profiles that link to \"%s\" will also be updated to \"%s\". Proceed?"
-- TAGS
L["tags"] = "Tags"
L["No tag"] = "No Tag"
...
L["Hexawing Dragonhawks"] = "Hexawing Dragonhawks"
...
L["Yetis"] = "Yetis"
L["Zhevras"] = "Zhevras"
L["Zothwing Seekers"] = "Zothwing Seekers"
