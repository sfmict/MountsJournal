...
L["CTRL + drag to sort mounts"] = "CTRL + перетащить для сортировки маунтов"
L["Reset custom sorting"] = "Сбросить ручную сортировку"
...
L["Additional First"] = "Дополнительные вначале"
...
L["Show mount expansion art"] = "Показывать дополнение маунта на фоне"
L["MOUNT_EXPANSION_ART_DESCRIPTION"] = "Отображет арт дополнения за маунтами в режиме 3D-сетки."
...
L["Change random mount"] = "Менять случайного маунта"
L["On each summon"] = "При каждом призыве"
L["Every %s sec"] = "Каждые %s сек"
L["Every %s min"] = "Каждые %s мин"
...
L["STATISTICS_DESCRIPTION"] = "Собирает время и расстояние поездок верхом (загружает ЦП, только когда персонаж сидит верхом)"
L["Show mount in unit tooltip"] = "Показывать средство передвижения в подсказке юнита"
L["Add information to item tooltip"] = "Добавлять информацию в подсказку предметов"
...
L["Alternative Mode"] = "Альтернативный режим"
L["CONDITION_DATA_SECRET_INFO"] = "Всегда ложно когда данные засекречены.\nИгра не позволяет проверить условие в некоторых ситуациях."
L["NOT_CONDITION"] = "Не"
...
L["Have zone spell"] = "Есть заклинание зоны"
...
L["Quest completed on account"] = "Задание выполнено на аккаунте"
L["Sex"] = "Пол"
...
L["Random Mount of Selected Type by Rarity"] = "Случайный маунт выбранного типа по редкости"
...
L["Chat is restricted due to secrets."] = "Чат ограничен из-за секротов."
-- ANIMATIONS
...
L["Pet binding from profile"] = "Привязка питомцев из профиля"
L["Zone settings from profile"] = "Настройка зон из профиля"
...
L["Other profiles that link to \"%s\" will also be updated to \"%s\". Proceed?"] = "Другие профили, ссылающиеся на \"%s\", также будут изменены на \"%s\". Продолжить?"
-- TAGS
L["tags"] = "Теги"
L["No tag"] = "Без тегов"
...
L["Alpacas"] = "Альпаки"
L["Amani Eagles"]= "Аманийские орлы"
L["Amphibian"] = "Амфибии"
L["Animite"] = "Анимаклещи"
L["Anthropoids"] = "Антропоиды"
...
L["Bloodtusks"] = "Кровобивни"
L["Boars"] = "Кабаны"
L["Book"] = "Книги"
L["Bovids"] = "Полорогие"
L["Broom"] = "Метлы"
L["Bruffalons"] = "Зуброны"
L["Brutosaurs"] = "Брутозавры"
L["Butterflies"] = "Бабочки"
L["Camels"] = "Верблюды"
L["Carnivorans"] = "Плотоядные"
L["Carpets"] = "Ковры"
L["Carrion Birds"] = "Падальщики"
L["Cats"] = "Кошки"
L["Celestials"] = "Небожители"
L["Cervid"] = "Сервиды"
L["Chargers"] = "Боевые"
L["Chickens"] = "Курицы"
L["Chloroceroses"] = "Хлороцеросы"
...
L["Crows"] = "Вороны"
L["Darkmoon Chargers"] = "Скакуны новолуния"
...
L["Fel Bats"] = "Сквернотопыри"
L["Felsabers"] = "Саблезубы"
L["Fire Hawks"] = "Огнеястребы"
L["Fireflies"] = "Светлячки"
L["Fish"] = "Рыбы"
L["Flies"] = "Мухи"
...
L["Krolusks"] = "Кролуски"
L["Larion"] = "Ларионы"
L["Leafmimics"] = "Хамелеоны"
L["Lions"] = "Львы"
L["Lizards"] = "Ящерицы"
L["Lupine"] = "Люпины"
L["Lynx"] = "Рыси"
L["Magmammoths"] = "Магмамонты"
L["Mammoths"] = "Мамонты"
L["Mana Rays"] = "Манаскаты"
L["Mana Wyrms"] = "Маназмеи"
L["Manasabers"] = "Манапарды"
L["Mauler"] = "Терзатели"
L["Mawrats"] = "Крысы Утробы"
...
L["Pandas"] = "Панды"
L["Pangolins"] = "Панголины"
L["Parrots"] = "Попугаи"
L["Peafowl"] = "Павлины"
L["Petalwings"] = "Перецветники"
L["Phoenixes"] = "Фениксы"
L["Proto-Drakes"] = "Протодраконы"
L["Pterrordaxes"] = "Терродактили"
L["Quilen"] = "Цийлини"
L["Rabbit"] = "Кролики"
L["Ramoliths"] = "Баранолиты"
L["Rams"] = "Бараны"
L["Raptora"] = "Рапторы"
L["Raptors"] = "Ящеры"
L["Rats"] = "Крысы"
...
L["Seat"] = "Повозки"
L["Seekers"] = "Дозорные"
L["Serpents"] = "Змееподобные"
L["Shadehounds"] = "Темные гончие"
L["Shalewings"] = "Глинокрылы"
L["Shardhides"] = "Кристаллошкуры"
L["Shredclaw"] = "Саблекогти"
L["Silithids"] = "Силитиды"
L["Skitterflies"] = "Стрекотухи"
L["Skyflayer"] = "Неборезы"
L["Skyrazor"] = "Рассекатели небес"
L["Slatebacks"] = "Сланцеспины"
L["Slitherdrakes"] = "Драконозмеи"
L["Slug"] = "Слизняки"
L["Snail"] = "Улитки"
L["Snapdragons"] = "Вараны"
L["Snaplizards"] = "Варвараны"
L["Snapvines"]= "Диколозы"
L["Spider Tanks"] = "Механопауки"
L["Spiders"] = "Пауки"
L["Sporebat"] = "Спороскат"
L["Sporegliders"] = "Споролеты"
L["Stag"] = "Олени"
L["Steeds"] = "Кони"
...
L["Talonbirds"] = "Когти"
L["Tauralus"] = "Тауралы"
L["Terror Flyers"] = "Летуны ужаса"
L["Thunder Lizard"] = "Громоспины"
L["Tigers"] = "Тигры"
L["Toads"] = "Жабы"
L["Turkeys"] = "Индюшки"
L["Turtles"] = "Черепахи"
L["Undead Birds"] = "Птицы нежить"
...
L["Yetis"] = "Йети"
L["Zhevras"] = "Жевры"
L["Zothwing Seekers"] = "Зотокрылые искатели"
